...
@section('content')
  <main>
    <div class="position-relative">
      <section class="masthead section section-lg section-shaped pt-5 pb-250" style="background-image: url({{ asset('/images/mastheads/masthead-4.jpg') }}?v={{ cache('v') }});" id="masthead">

...
@section('content')
  <main>
    ...
    <section class="section section-lg pt-lg-0 mt--200" id="section-0">
      <div class="container">
    ...
    <section class="section bg-secondary" id="section-2">
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6">
    ...
    <section class="section pb-0 bg-gradient-warning" id="section-3">
      <div class="container">
        <div class="row row-grid align-items-center">
    ...
    <section class="section section-lg" id="section-4">
      <div class="container">
    ...
    <section class="section section-lg pt-0" id="section-5">
      <div class="container">
    ...
    <section class="section section-lg" id="section-7">
      <div class="container">

                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <base-button tag="a" href="javascript:{}" type="primary" class="mt-4">
                                        Learn more
                                    </base-button>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <base-button tag="a" href="javascript:{}" type="success" class="mt-4">
                                        Learn more
                                    </base-button>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <base-button tag="a" href="javascript:{}" type="warning" class="mt-4">
                                        Learn more
                                    </base-button>
                                </card>
                            </div>
                ...
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="pl-md-5">
                            ...
                            <p>The kit comes with three pre-built pages to help you get started faster. You can change
                                the text and images and you're good to go.</p>
                            <a href="javascript:{}" class="font-weight-bold text-warning mt-5">A beautiful UI Kit for impactful
                                websites</a>
                        </div>
                    </div>
                </div>
                        ...
                        <card shadow class="shadow-lg--hover mt-5">
                            <div class="d-flex px-3">
                                ...
                                <div class="pl-4">
                                    ...
                                    <a href="javascript:{}" class="text-success">Learn more</a>
                                </div>
                            </div>
                        </card>
                        <card shadow class="shadow-lg--hover mt-5">
                            <div class="d-flex px-3">
                                ...
                                <div class="pl-4">
                                    ...
                                    <p>The Arctic Ocean freezes every winter and much of the sea-ice then thaws
                                        every summer, and that process will continue whatever happens.</p>
                                    <a href="javascript:{}" class="text-warning">Learn more</a>
                                </div>
                            </div>
                        </card>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                ...
                                <div class="mt-3">
                                    <base-button tag="a" href="javascript:{}" type="warning" icon="fa fa-twitter" rounded
                                                 icon-only></base-button>
                                    <base-button tag="a" href="javascript:{}" type="warning" icon="fa fa-facebook" rounded
                                                 icon-only></base-button>
                                    <base-button tag="a" href="javascript:{}" type="warning" icon="fa fa-dribbble" rounded
                                                 icon-only></base-button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                ...
                                <div class="mt-3">
                                    <base-button tag="a" href="javascript:{}" type="primary" icon="fa fa-twitter" rounded
                                                 icon-only></base-button>
                                    <base-button tag="a" href="javascript:{}" type="primary" icon="fa fa-facebook" rounded
                                                 icon-only></base-button>
                                    <base-button tag="a" href="javascript:{}" type="primary" icon="fa fa-dribbble" rounded
                                                 icon-only></base-button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                ...
                                <div class="mt-3">
                                    <base-button tag="a" href="javascript:{}" type="info" icon="fa fa-twitter" rounded
                                                 icon-only></base-button>
                                    <base-button tag="a" href="javascript:{}" type="info" icon="fa fa-facebook" rounded
                                                 icon-only></base-button>
                                    <base-button tag="a" href="javascript:{}" type="info" icon="fa fa-dribbble" rounded
                                                 icon-only></base-button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="px-4">
                            ...
                            <div class="pt-4 text-center">
                                ...
                                <div class="mt-3">
                                    <base-button tag="a" href="javascript:{}" type="success" icon="fa fa-twitter" rounded
                                                 icon-only></base-button>
                                    <base-button tag="a" href="javascript:{}" type="success" icon="fa fa-facebook" rounded
                                                 icon-only></base-button>
                                    <base-button tag="a" href="javascript:{}" type="success" icon="fa fa-dribbble" rounded
                                                 icon-only></base-button>
                                </div>
                            </div>
                        </div>

        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <a href="javascript:{}" class="btn btn-link text-default">Default</a>
                    <a href="javascript:{}" class="btn btn-link text-primary">Primary</a>
                    <a href="javascript:{}" class="btn btn-link text-info">Info</a>
                    <a href="javascript:{}" class="btn btn-link text-success">Success</a>
                    <a href="javascript:{}" class="btn btn-link text-warning">Warning</a>
                    <a href="javascript:{}" class="btn btn-link text-danger">Danger</a>
                </div>
            </div>
        </div>
    </section>
